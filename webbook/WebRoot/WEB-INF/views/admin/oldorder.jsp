			                  ...
			                  <ul>
			                    <c:if test="${mypage.totalPages>1}">
			                    	 <c:choose>
			       					  	...
			       					  	<c:otherwise>
			       					  		<li><a href="/admin/oldorder/1">首页</a></li>
			       					  		<li><a href="/admin/oldorder/${mypage.pageNum-1}">上一页</a></li>
			       					  	</c:otherwise>
							          </c:choose>
			       					  <c:choose>
			       					  	...
			       					  	<c:otherwise>
			       					  		<li><a href="/admin/oldorder/${mypage.pageNum+1}">下一页</a></li>
			       					  		<li><a href="/admin/oldorder/${mypage.totalPages}">尾页</a></li>
			       					  	</c:otherwise>
			       					  </c:choose>
			                    </c:if>
			                  </ul>
