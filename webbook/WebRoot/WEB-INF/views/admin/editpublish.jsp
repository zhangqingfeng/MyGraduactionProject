        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="page-header">
                  <h4><i class="icon-plus"></i> 修改出版社名称</h4>
                </div>
                <form class="form-horizontal" action="/admin/publish/edit" method="post">
                  <div class="control-group">
                    <label class="control-label" for="inputEmail">类别名称</label>
                    <div class="controls">
                      <input type="hidden" name="id" value="${publish.id }">
                      <input type="text" name="pubname" placeholder="${publish.pubname }">
                    </div>
                  </div>
                  <div class="control-group">
                    <div class="controls">
