			                  ...
			                  <ul>
			                    <c:if test="${page.totalPages>1}">
			                    	 <c:choose>
			       					  	...
			       					  	<c:otherwise>
			       					  		<li><a href="/user/home/1">首页</a></li>
			       					  		<li><a href="/user/home/${page.pageNum-1}">上一页</a></li>
			       					  	</c:otherwise>
							          </c:choose>
			       					  <c:choose>
			       					  	...
			       					  	<c:otherwise>
			       					  		<li><a href="/user/home/${page.pageNum+1}">下一页</a></li>
			       					  		<li><a href="/user/home/${page.totalPages}">尾页</a></li>
			       					  	</c:otherwise>
			       					  </c:choose>
			                    </c:if>
			                  </ul>
