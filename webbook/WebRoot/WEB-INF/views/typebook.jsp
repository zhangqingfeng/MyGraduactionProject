	        		...
	        		<div class="span9 block">
	        			...
	        			<div class="block-body">
				            ...
				            <table class="table list">
				            	<tbody>
				            		<c:forEach items="${typepage.result }" var="b">
				            		<tr>
				            			...
				            			<td>
						            		...
						            		<div>
						            			...
						            			<a href="#" class="btn btn-mini">收藏</a>
						            		</div>
						            	</td>
				            		</tr> 
				            		</c:forEach>
							...
							<div class="pagination pull-right">
			                  <ul>
			                    <c:if test="${typepage.totalPages>1}">
			                    	 <c:choose>
			       					  	<c:when test="${typepage.pageNum==1}">
			       					  		<li><a class="diable">首页</a></li>
			       					  		<li><a class="diable">上一页</a></li>
			       					  	</c:when>
			       					  	<c:otherwise>
			       					  		<li><a href="/user/type/${type.id }/1">首页</a></li>
			       					  		<li><a href="/user/type/${type.id }/${typepage.pageNum-1}">上一页</a></li>
			       					  	</c:otherwise>
							          </c:choose>
			       					  <c:choose>
			       					  	<c:when test="${typepage.pageNum==typepage.totalPages}">
			       					  		<li><a class="diable">下一页</a></li>
			       					  		<li><a class="diable">尾页</a></li>
			       					  	</c:when>
			       					  	<c:otherwise>
			       					  		<li><a href="/user/type/${type.id }/${typepage.pageNum+1}">下一页</a></li>
			       					  		<li><a href="/user/type/${type.id }/${typepage.totalPages}">尾页</a></li>
			       					  	</c:otherwise>
			       					  </c:choose>
			                    </c:if>
			                  </ul>
